...
//					alert(me.left);
//					alert(me.bottom);
//					$('#here').css("left",me.left);
//					$('#here').css("bottom",me.bottom);
					//alert(index);
			...
			move: function(preStep, index) {
				...
				switch (direction) {
					case -1: //从右往左移动
						alert("从右往左");
						left = left - 70;
						$('#here').css("transform","translate3d(" + left + "px,0,0)");
						$('#here').css("-webkit-transform","translate3d(" + left + "px,0,0)");
//						me.left = $('#here').css("left");
						break;
					case 1: //从左往右移动
					alert("从左往右");
						left = left + 70;
...
//						me.left = $('#here').css("left");
					...
					alert("从下往上");
						bottom = bottom + 72;
						$('#here').css("transform","translate3d(0," + bottom + "px,0)");
						$('#here').css("-webkit-transform","translate3d(0," + bottom + "px,0)");
//						me.bottom = $('#here').css("bottom");
						break;
					case 7: //从上往下移动
					alert("从上往下");
						bottom = bottom - 72;
...
//				setTimeout(function(){
//					$('#here').removeClass("ltr");
//					$('#here').removeClass("rtl");
//					$('#here').removeClass("ttb");
//					$('#here').removeClass("btt");
//				},300);
